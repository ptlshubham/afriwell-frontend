...
import { Product, ColorFilter } from 'src/app/components/modals/product.model';
...
export class ProductNoSidebarComponent implements OnInit {
  ...
  public onChangeSorting(val: any) {
  ...
  public filterItems(): Product[] {
    return this.items.filter((item: Product) => {
      const Colors: boolean = this.colorFilters.reduce((prev: any, curr: any) => { // Match Color
        if (item.colors) {
